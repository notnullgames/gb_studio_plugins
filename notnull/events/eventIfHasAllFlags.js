...
export const id = 'NOTNULL_IF_FLAGS_HAS_ALL'
...
export const compile = (input, helpers) => {
  ...
  // TODO: logic is inverted here, but I could not get it to work
  ifVariableBitwiseValue(input.variable, '.B_XOR', flag, falsePath, truePath)
}
